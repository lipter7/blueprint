...
Instead, please report them via email to: **[maintainer email - TODO]** (or open a private security advisory on GitHub)
...
Security issues in the Blueprint codebase that could:
