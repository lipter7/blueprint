...
Template for `.blueprint/phases/XX-name/{phase}-UAT.md` — persistent UAT session tracking.
...
- This section feeds directly into /bp:plan-phase --gaps
...
5. status → "diagnosed"
6. Ready for /bp:plan-phase --gaps with root causes
...
**Creation:** When /bp:verify-work starts new session
