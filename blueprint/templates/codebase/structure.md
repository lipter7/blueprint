...
Template for `.blueprint/codebase/STRUCTURE.md` - captures physical file organization.
...
│   └── bp/            # Blueprint-specific commands
├── blueprint/     # Skill resources
...
**blueprint/templates/**
- Purpose: Document templates for .blueprint/ files
...
**New Slash Command:**
- Primary code: `commands/bp/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `blueprint/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `blueprint/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/blueprint/workflows/{name}.md`

**New Reference Document:**
- Implementation: `blueprint/references/{name}.md`
