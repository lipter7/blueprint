...
Template for `.blueprint/phases/XX-name/{phase}-RESEARCH.md` - comprehensive ecosystem research before planning.
...
**CRITICAL:** If CONTEXT.md exists from /bp:discuss-phase, copy locked decisions here verbatim. These MUST be honored by the planner.
...
**Structure:**
- Use XML tags for section markers (matches Blueprint templates)
...
**After creation:**
- File lives in phase directory: `.blueprint/phases/XX-name/{phase}-RESEARCH.md`
