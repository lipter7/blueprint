...
This template is used by the complete-milestone workflow to create archive files in `.blueprint/milestones/`.
...
_For current project status, see .blueprint/ROADMAP.md_
...
- Save to `.blueprint/milestones/v{VERSION}-{NAME}.md`
- Example: `.blueprint/milestones/v1.0-mvp.md`
