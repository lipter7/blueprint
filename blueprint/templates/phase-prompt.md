...
> **Note:** Planning methodology is in `agents/bp-planner.md`.
> This template defines the PLAN.md output format that the agent produces.

Template for `.blueprint/phases/XX-name/{phase}-{plan}-PLAN.md` - executable phase plans optimized for parallel execution.
...
<!-- For checkpoint task examples and patterns, see @~/.claude/blueprint/references/checkpoints.md -->
...
**Wave is pre-computed:** Wave numbers are assigned during `/bp:plan-phase`. Execute-phase reads `wave` directly from frontmatter and groups plans by wave number. No runtime dependency analysis needed.
...
```markdown
<context>
@.blueprint/phases/03-features/03-01-SUMMARY.md  # Just because it's earlier
@.blueprint/phases/03-features/03-02-SUMMARY.md  # Reflexive chaining
</context>
```
...
See `~/.claude/blueprint/references/tdd.md` for TDD plan structure.
...
<output>
After completion, create `.blueprint/phases/03-features/03-01-SUMMARY.md`
</output>
```
...
@.blueprint/PROJECT.md
@.blueprint/ROADMAP.md
@.blueprint/phases/03-features/03-01-SUMMARY.md
@.blueprint/phases/03-features/03-02-SUMMARY.md
</context>
...
<output>
After completion, create `.blueprint/phases/03-features/03-03-SUMMARY.md`
</output>
```
...
See `~/.claude/blueprint/templates/user-setup.md` for full schema and examples
...
See `~/.claude/blueprint/workflows/verify-phase.md` for verification logic.
