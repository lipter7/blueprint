...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /bp:research-phase instead, which produces RESEARCH.md.
</purpose>
...
See ~/.claude/blueprint/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/blueprint/templates/discovery.md structure:
...
**Output:** `.blueprint/phases/XX-name/DISCOVERY.md`
</step>
...
1. **Scope the discovery** using ~/.claude/blueprint/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/blueprint/templates/discovery.md
...
**Output:** `.blueprint/phases/XX-name/DISCOVERY.md` (comprehensive)
</step>
...
Use ~/.claude/blueprint/templates/discovery.md.
...
Write `.blueprint/phases/XX-name/DISCOVERY.md`:
- Summary with recommendation
...
```
Discovery complete: .blueprint/phases/XX-name/DISCOVERY.md
Recommendation: [one-liner]
Confidence: [level]

What's next?

1. Discuss phase context (/bp:discuss-phase [current-phase])
2. Create phase plan (/bp:plan-phase [current-phase])
